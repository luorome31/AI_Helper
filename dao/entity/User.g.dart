...
void _userSerialize(
  ...
  writer.writeLong(offsets[6], object.role);
}
...
User _userDeserialize(
  ...
  final object = User(
    ...
    gender: reader.readBool(offsets[3]),
    goal: reader.readLong(offsets[4]),
    id: id,
    name: reader.readString(offsets[5]),
    role: reader.readLong(offsets[6]),
  );
  return object;
}
...
List<IsarLinkBase<dynamic>> _userGetLinks(User object) {
  return [object.records, object.notes];
}
...
extension UserQueryLinks on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> records(
